...
# Literature Review
Economists have been studying how people make decisions since the beginning days of the social science. One of these decisions includes financial decisions. The field of economics studies 
...
- Here are some summary statistics of my SUBSETTED data broken out by Age, Education Level, Labor Force Participation, income level, race, marital status, dependent children
...
```{r Preliminary Multicollinearity Check}
...
```{r Logit Model with Interactions}
...
- Determine if I want to look at certain subgroups within my data - maybe looking specifically on an income group might tell me something interesting about my data
...
Look for an academic paper that finds out if people know the difference between anixety and stress
